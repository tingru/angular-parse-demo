...
angular.module('ToDoApp', [])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = '6m2L13eDcLvdN3uhAvfZYIRc2y3YVAD8Tx9U0Szm';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'zPs6zTpEfwP71IuACo8625N5SY4is1jddtAQb0R4';
    });
